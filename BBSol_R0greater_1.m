...
params = [1.25382975108040	8.08568819620768	0.578027454719331	6.83970198884737e-07 0.09234664];% FINAL RESULT EE and R0>1. This is the set of estimated parameter. 
% and T = 6000;
...
R0
figure(1)
plot(time_mesh,I, '-b','LineWidth',4)
...
% Nv =  10000;%500;
% Lambda_v = 0.98*Nv*1/10;%1/10;%10000; % 
%  muv = 1/10;%1/30;  muv = 1/10;%1/30; 
N_v = 55000;

Lambda_v = N_v*1/10;%1/10;%10000; % 
 muv = 1/10;%1/30;  muv = 1/10;%1/30; 

mu_h = 1/(79*365); % host natural death rate
Lambda_h = 20612439*mu_h; % host recruitment rate 
%Lambda_h = 20630000*mu_h; % host recruitment rate 
